...
const PAGES = {
  about: {
    ...
    lede: `${N} exists because buying an espresso machine on Amazon is unnecessarily hard: a hundred near-identical listings, inflated pressure claims, and reviews you can&rsquo;t weigh. We do the comparing.`,
    body: `
...
<p>Our starting point is a database of every espresso machine we can source through Amazon&rsquo;s official product API — 32 machines for this category at the time of writing. From there the work is comparison, not curation-by-vibes:</p>
<ul>
  <li>We sort machines by what they mechanically <em>are</em> — steam-driven, pump semi-automatic, super-automatic or capsule — because that decides more about your morning than any feature list.</li>
  <li>We read the specifications that change the cup: whether a burr grinder is included, boiler wattage, tank size, brew-temperature control, the steam wand, and the physical footprint.</li>
  <li>We treat manufacturer marketing sceptically. In this category the headline numbers are frequently misleading — a &ldquo;20 bar&rdquo; pump rating tells you nothing about the roughly 9 bar that actually brews espresso.</li>
...
<p>Start with <a href="/">the eight machines we recommend</a>, or browse <a href="/guides">every guide</a>.</p>`,
...
<ul>
  <li><strong>Corrections.</strong> A wrong specification, a machine that&rsquo;s been discontinued, a price that&rsquo;s badly out of date, a broken link. These get fixed fastest.</li>
...
<ul>
  <li><strong>Repairs and warranty claims.</strong> We don&rsquo;t sell machines and have no access to any order. Contact the manufacturer or the retailer you bought from.</li>
...
<meta name="theme-color" content="#1A100C">
<style>
  :root{--dark:#1A100C;--dark2:#2C1C14;--on:#F4EAE1;--mute:#B69C8B;--copper:#E08B4E;--brass:#DFBB78;
  ...
  *{box-sizing:border-box}
  ...
  a.cta{display:inline-flex;align-items:center;gap:8px;background:var(--copper);color:#24120A;font-weight:700;
...
<main>
  <p class="n">404</p>
  <h1>That page has gone cold</h1>
  <p>The link you followed doesn&rsquo;t exist &mdash; or it moved. The guide to the eight machines we recommend is still where you left it.</p>
  <a class="cta" href="/">Back to the espresso machine guide →</a>
